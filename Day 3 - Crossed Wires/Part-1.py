...
for x in range(len(complete_route_1)):
    for y in range(len(complete_route_2)):
        if complete_route_1[x] == complete_route_2[y] and complete_route_1[x] != [0,0] and complete_route_2[y] != [0,0]:
            intersections.append(complete_route_1[x])
