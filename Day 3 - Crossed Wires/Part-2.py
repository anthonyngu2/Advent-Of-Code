...
for x in range(len(intersections)):
    steps_1 = len(complete_route_1[:complete_route_1.index(intersections[x])])
    steps_2 = len(complete_route_2[:complete_route_2.index(intersections[x])])
